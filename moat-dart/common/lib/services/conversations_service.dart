...
/// Service for managing the conversations list.
/// No Flutter dependency — pure Dart extracted from ConversationsProvider.
class ConversationsService {
  ...
  ConversationsService({required ConversationStorage storage})
      : _storage = storage;
  ...
  Future<void> init() async {
    ...
    try {
      ...
      moatLog('ConversationsService: Failed to load conversations: $e');
      _conversations = [];
    }
  ...
  Future<void> refresh() async {
    ...
    try {
      ...
      moatLog('ConversationsService: Failed to refresh conversations: $e');
    }
