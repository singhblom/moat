//! Three-party polling delivery scenario.
//!
//! Alice creates a group with Bob, then adds Carol. All three exchange messages
//! via polling. Uses the generalized N-participant helpers.
...
pub async fn run(actions: Vec<Action>, verbose: bool) {
    vlog!(verbose, "=== Scenario: three-party-chat ===");
